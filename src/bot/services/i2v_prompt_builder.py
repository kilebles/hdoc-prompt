...
SUBJECT_EXTRACTION_INSTRUCTION = (
    ...
    "- a person described specifically enough to search for by role, title, "
    "appearance, or attire — by role/title ONLY, NEVER by proper name, no "
    "exceptions (e.g. \"elder Apache woman grinding corn\", \"young warrior in "
    "buckskin leggings\", \"Roman emperor\", \"Roman general\")\n"
    "\n"
    "NEVER extract:\n"
    ...
    "\"resilience\")\n"
    "- a named individual, by proper name, under ANY circumstance — this "
    "includes famous rulers and historical figures who have surviving statues, "
    "busts, or coin portraits (e.g. write \"Roman emperor\" or \"Roman general\", "
    "NEVER \"Nero\", \"Vespasian\", \"Julius Caesar\", or any other proper name — "
    "the query text itself must never contain a person's name, a stock site "
    "search on a proper name returns actor portrayals and unrelated results, "
